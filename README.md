...
While the `--refactor` flag is useful, not all built-in hints support refactoring. [hints.md](hints.md) documents which hints do and do not support refactoring.
